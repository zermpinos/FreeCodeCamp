...
class UnitTests(unittest.TestCase):
    ...
    def test_deposit(self):
        ...
        actual = self.food.records[0]
        expected = {"amount": 900, "description": "deposit"}
        self.assertEqual(actual, expected, 'Expected `deposit` method to create a specific object in the records instance variable.')
    ...
    def test_withdraw(self):
        ...
        actual = self.food.records[1]
        expected = {"amount": -45.67, "description": "milk, cereal, eggs, bacon, bread"}
        self.assertEqual(actual, expected, 'Expected `withdraw` method to create a specific object in the records instance variable.')
    ...
    def test_transfer(self):
        ...
        actual = self.food.records[2]
        expected = {"amount": -transfer_amount, "description": "Transfer to Entertainment"}
        self.assertEqual(actual, expected, 'Expected `transfer` method to create a specific records item in food object.')
        ...
        actual = self.entertainment.records[0]
        expected = {"amount": transfer_amount, "description": "Transfer from Food"}
        self.assertEqual(actual, expected, 'Expected `transfer` method to create a specific records item in entertainment object.')
